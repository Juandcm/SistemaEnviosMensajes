...
var App = function() {
    ...
    var uiInit = function() {
        ...
        sidebarAlt2      = $('#sidebar-alt2');
        sScrollAlt      = $('#sidebar-scroll-alt');
        sScrollAlt2      = $('#sidebar-scroll-alt2');
        ...
        if (mode === 'init') {
            ...
            if (mode === 'toggle-sidebar') {
                ...
                if ( windowW > 991) { // Toggle alternative sidebar in large screens (> 991px)
                    ...
                    page.removeClass('sidebar-alt-visible-lg2');
                } else { // Toggle alternative sidebar in small screens (< 992px)
                    page.toggleClass('sidebar-alt-visible-xs');
                    page.removeClass('sidebar-alt-visible-xs2');
            ...
            else if (mode === 'toggle-sidebar-alt2') {
                if ( windowW > 991) { // Toggle alternative sidebar in large screens (> 991px)
                    page.toggleClass('sidebar-alt-visible-lg2');
                    page.removeClass('sidebar-alt-visible-lg');
                } else { // Toggle alternative sidebar in small screens (< 992px)
                    page.toggleClass('sidebar-alt-visible-xs2');
                    page.removeClass('sidebar-alt-visible-xs');

                    if (page.hasClass('sidebar-alt-visible-xs2')) {
                        handleSidebar('close-sidebar2');
                    }
                }
            }
            ...
            else if (mode === 'close-sidebar-alt2') {
                if ( windowW > 991) { // Close alternative sidebar in large screens (> 991px)
                    page.removeClass('sidebar-alt-visible-lg2');
                } else { // Close alternative sidebar in small screens (< 992px)
                    page.removeClass('sidebar-alt-visible-xs2');
            ...
            else if (mode === 'sidebar-alt2-scroll') { // Init alternative sidebar scrolling
                if (sScrollAlt2.length && (!sScrollAlt2.parent('.slimScrollDiv').length)) { // If scrolling does not exist init it..
                    sScrollAlt2.slimScroll({
                        height: sidebarAlt2.outerHeight(),
                        color: '#bbbbbb',
                        size: '3px',
                        touchScrollStep: 100,
                        railVisible: false,
                    ...
                    sScrollAlt2.add(sScrollAlt2.parent()).css('height', sidebarAlt2.outerHeight());
                }
            }
        }
    };
